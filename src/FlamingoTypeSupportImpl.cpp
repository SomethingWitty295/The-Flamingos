...
{
  static const XTypes::TypeIdentifier ti = XTypes::TypeIdentifier(XTypes::EK_MINIMAL,XTypes::EquivalenceHashWrapper(206, 16, 177, 157, 79, 100, 224, 117, 32, 226, 14, 171, 124, 188));
  return ti;
}
...
{
  XTypes::TypeMap tm;
  tm[XTypes::TypeIdentifier(XTypes::EK_MINIMAL,XTypes::EquivalenceHashWrapper(206, 16, 177, 157, 79, 100, 224, 117, 32, 226, 14, 171, 124, 188))] = to0();
  return tm;
}
}
